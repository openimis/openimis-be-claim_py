            ...
            "contentDataRows": [
                {
                    ...
                    "columnData": [
                        ...
                        },
                        {
                            ...
                            "id": 294,
                            "width": 430,
                            "content": "${region_code} + ' - ' + ${region_name} if ${region_code} else 'All regions'",
                            "eval": true,
                            "colspan": "",
                            "styleId": "",
                            "bold": false,
                ...
                },
                {
                    ...
                    "columnData": [
                        ...
                        },
                        {
                            ...
                            "id": 300,
                            "width": 430,
                            "content": "${district_code} + \" -  \" + ${district_name} if ${district_code} else 'All districts'",
                            "eval": true,
                            "colspan": "",
                            "styleId": "",
                            "bold": false,
                ...
                },
                {
                    ...
                    "columnData": [
                        ...
                        },
                        {
                            ...
                            "id": 303,
                            "width": 430,
                            "content": "${hf_code} + ' - ' + ${hf_name} if ${hf_code} else 'All health facilities'",
                            "eval": true,
                            "colspan": "",
                            "styleId": "",
                            "bold": false,
                ...
                },
                {
                    ...
                    "columnData": [
                        ...
                        },
                        {
                            ...
                            "id": 306,
                            "width": 430,
                            "content": "${product_code} + ' - ' + ${product_name} if ${product_code} else 'All products'",
                            "eval": true,
                            "colspan": "",
                            "styleId": "",
                            "bold": false,
                ...
                },
                {
                    ...
                    "columnData": [
                        ...
                        },
                        {
                            ...
                            "id": 312,
                            "width": 430,
                            "content": "'Claims only' if ${scope} == 0 else ('Claims and rejection details' if ${scope} == 1 else ('Claims and all details' if ${scope} == 2 else 'Error'))",
                            "eval": true,
                            "colspan": "",
                            "styleId": "",
                            "bold": false,
                    ...
                    "columnData": [
                        {
                            ...
                            "id": 390,
                            "width": 70,
                            "content": "'Claim n°' + str(${c_code}) + ' - ' + ${c_insuree_other_names} + ' ' + ${c_insuree_name} + ' (' + ${c_insuree_nbr} + ') in '  + ${c_health_facility_code} + ' ' + ${c_health_facility_name} + ' - claimed on ' + str(${c_date_claimed})",
                            "eval": true,
                            "colspan": "9",
                            "styleId": "",
                            "bold": true,
...
def claims_overview_query(user, region_id=0, district_id=0, date_start="2019-01-01", date_end="2022-12-31",
                          product_id=0, hf_id=0, claim_status=None, scope=0, **kwargs):
    # Scope values:
    # no scope = -1
    # claim only = 0
    # claim and rejection = 1
    # all = 2

    region = Location.objects.filter(id=region_id).first() if region_id != 0 else None
    district = Location.objects.filter(id=district_id).first() if district_id != 0 else None
    product = Product.objects.filter(id=product_id).first() if product_id != 0 else None
    hf = HealthFacility.objects.filter(id=hf_id).first() if hf_id != 0 else None
    ...
    # Fetching the HF ID(s)
    if hf_id:
        claim_filters &= Q(health_facility_id=hf_id)
        header["hf_code"] = hf.code
        header["hf_name"] = hf.name
        header["district_code"] = district.code
        header["district_name"] = district.name
        header["region_code"] = region.code
        header["region_name"] = region.name
    else:
        # Possibly multiple HFs
        hf_id_filters = Q(validity_to__isnull=True)
        if district_id:
            hf_id_filters &= Q(location_id=district_id)
            header["district_code"] = district.code
            header["district_name"] = district.name
            header["region_code"] = region.code
            header["region_name"] = region.name
        elif region_id:
            district_ids = Location.objects.filter(Q(parent_id=region_id) & Q(validity_to__isnull=True))
            hf_id_filters &= Q(location_id__in=district_ids)
            header["region_code"] = region.code
            header["region_name"] = region.name

        hf_ids = HealthFacility.objects.filter(hf_id_filters)
        claim_filters &= Q(health_facility_id__in=hf_ids)
    ...
    if product_id:
        ...
        header["product_code"] = product.code
        header["product_name"] = product.name

    claim_queryset = Claim.objects.filter(claim_filters) \
        .distinct("insuree__chf_id", "code") \
        .order_by("insuree__chf_id", "code") \
