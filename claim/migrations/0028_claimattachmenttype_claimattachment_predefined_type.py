    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.SmallIntegerField(
                        db_column="ClaimAttachmentTypeId",
                        primary_key=True,
                        serialize=False,
                    ),
                ),
                (
                    ...
                    models.CharField(db_column="ClaimAttachmentType", max_length=50),
                ),
                ("is_autogenerated", models.BooleanField(default=False)),
                (
                    "claim_general_type",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="claim.claimattachmenttype",
            ),
        ),
        migrations.RunPython(
            code=insert_default_type, reverse_code=migrations.RunPython.noop
        ),
    ]
